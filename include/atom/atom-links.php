...
<title>Display links from an Atom feed</title></head>

	
<body bgcolor="#FFFFFF">
<h1>Atom Feed Load and Display Links Only</h1>
<hr>
<p>This demo loads a remote Atom feed and displays only the links of each entry 
  below.<br>
  It makes use of PHP and the atomlib.php library to extract and display the information.</p>
<p> Type the URL of an Atom file: </p>
<FORM name="rss" method="POST" action="atom-links.php">
<p>

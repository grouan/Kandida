...
<<<<<<< HEAD
		else { echo	"Une ERREUR s'est produite lors de l'envoi de votre message.<br><br>Essayez directement avec votre messagerie habituelle � l'adresse suivante : <A href=\"mailto:xxx@xxx.xxx?subject=cvrouan\" target=\"_blank\">xxx@xxx.xxx</A>"; }
=======
